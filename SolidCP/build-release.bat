...
%SCPMSBuild% build.xml /target:Build /p:BuildConfiguration=Release /p:Version="1.4.2" /p:FileVersion="1.4.2" /p:VersionLabel="1.4.2" /v:n /fileLogger /m /p:VisualStudioVersion=%SCPVSVer%
pause