...
%SCPMSBuild% build.xml /target:Build /p:BuildConfiguration=Release /p:Version="1.4.1" /p:FileVersion="1.4.1" /p:VersionLabel="1.4.1" /v:n /fileLogger /m /p:VisualStudioVersion=%SCPVSVer%