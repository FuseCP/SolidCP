...
%SCPMSBuild% build.xml /target:Deploy /p:BuildConfiguration=Debug /p:Version="1.4.3" /p:FileVersion="1.4.3" /p:VersionLabel="1.4.3" /v:n /fileLogger /m /p:VisualStudioVersion=%SCPVSVer%