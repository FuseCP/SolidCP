...
:Build
%SCPMSBuild% build.xml /target:Deploy /p:BuildConfiguration=Debug /p:Version="1.5.0" /p:FileVersion="1.5.0" /p:VersionLabel="1.5.0" /v:n /fileLogger /m /p:VisualStudioVersion=%SCPVSVer%