...
:Build
%SCPMSBuild% build.xml /target:Deploy /p:BuildConfiguration=Debug /p:Version="1.4.5" /p:FileVersion="1.4.6" /p:VersionLabel="1.4.6" /v:n /fileLogger /m /p:VisualStudioVersion=%SCPVSVer%