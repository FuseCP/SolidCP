...
:Build
%SCPMSBuild%  build.xml /target:Build /p:BuildConfiguration=Debug /p:Version="1.4.4" /p:FileVersion="1.4.4" /p:VersionLabel="1.4.4" /v:n /fileLogger /m /p:VisualStudioVersion=%SCPVSVer%