...
%SCPMSBuild%  build.xml /target:Build /p:BuildConfiguration=Debug /p:Version="1.4.0" /p:FileVersion="1.4.0" /p:VersionLabel="1.4.0" /v:n /fileLogger /m /p:VisualStudioVersion=%SCPVSVer%