...
:Build
%SCPMSBuild%  build.xml /target:Build /p:BuildConfiguration=Debug /p:Version="1.4.5" /p:FileVersion="1.4.7" /p:VersionLabel="1.4.7" /v:n /fileLogger /m /p:VisualStudioVersion=%SCPVSVer%