...
%SCPMSBuild% build.xml /target:Deploy /p:BuildConfiguration=Release /p:Version="1.4.4" /p:FileVersion="1.4.4" /p:VersionLabel="1.4.4" /v:n /fileLogger /m /p:VisualStudioVersion=%SCPVSVer%