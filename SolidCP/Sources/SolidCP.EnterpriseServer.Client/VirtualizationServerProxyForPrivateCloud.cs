...
// 
namespace SolidCP.EnterpriseServer.VirtualizationServerForPrivateCloud
{
    ...
    public partial class esVirtualizationServerForPrivateCloud : Microsoft.Web.Services3.WebServicesClientProtocol
    {
        ...
        private System.Threading.SendOrPostCallback GetVirtualNetworkOperationCompleted;
        ...
        /// <remarks/>
        public event GetVirtualNetworkCompletedEventHandler GetVirtualNetworkCompleted;
        ...
        public void CheckServerStateAsync(VMForPCSettingsName control, string connString, string connName, int serviceId, object userState)
        {
            ...
            this.InvokeAsync("CheckServerState", new object[] {
                        ...
                        connString,
                        connName,
                        serviceId}, this.CheckServerStateOperationCompleted, userState);
        }
        ...
        public void GetClustersAsync(int serviceId, object userState)
        {
            ...
            this.InvokeAsync("GetClusters", new object[] {
                        serviceId}, this.GetClustersOperationCompleted, userState);
        }
        ...
        public void GetMaximumCpuCoresNumberAsync(int packageId, string templateId, object userState)
        {
            ...
            this.InvokeAsync("GetMaximumCpuCoresNumber", new object[] {
                        packageId,
                        templateId}, this.GetMaximumCpuCoresNumberOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void CreateVMFromVMAsync(int packageId, VMInfo vmTemplate, string vmName)
        {
            this.CreateVMFromVMAsync(packageId, vmTemplate, vmName, null);
        }

        /// <remarks/>
        public void CreateVMFromVMAsync(int packageId, VMInfo vmTemplate, string vmName, object userState)
        {
        ...
        public IntResult CreateVirtualMachine(
                    ...
                    string externalNetworkLocation,
                    string externalNicMacAddress,
                    string externalVirtualNetwork,
                    bool privateNetworkEnabled,
                    string privateNetworkLocation,
                    string privateNicMacAddress,
                    string privateVirtualNetwork,
                    ushort privateVLanID)
        {
                    ...
                    object asyncState)
        {
            return this.BeginInvoke("CreateVirtualMachine", new object[] {
                        ...
                        privateNicMacAddress,
                        privateVirtualNetwork,
                        privateVLanID}, callback, asyncState);
        }
                    ...
                    object userState)
        {
            ...
            this.InvokeAsync("CreateVirtualMachine", new object[] {
                        ...
                        privateNicMacAddress,
                        privateVirtualNetwork,
                        privateVLanID}, this.CreateVirtualMachineOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGetDeviceEvents(int ItemID, System.AsyncCallback callback, object asyncState)
        {
        ...
        /// <remarks/>
        public void GetDeviceEventsAsync(int ItemID)
        {
            this.GetDeviceEventsAsync(ItemID, null);
        }

        /// <remarks/>
        public void GetDeviceEventsAsync(int ItemID, object userState)
        {
            ...
            this.InvokeAsync("GetDeviceEvents", new object[] {
                        ItemID}, this.GetDeviceEventsOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGetMonitoringAlerts(int ItemID, System.AsyncCallback callback, object asyncState)
        {
        ...
        /// <remarks/>
        public void GetMonitoringAlertsAsync(int ItemID)
        {
            this.GetMonitoringAlertsAsync(ItemID, null);
        }

        /// <remarks/>
        public void GetMonitoringAlertsAsync(int ItemID, object userState)
        {
            ...
            this.InvokeAsync("GetMonitoringAlerts", new object[] {
                        ItemID}, this.GetMonitoringAlertsOperationCompleted, userState);
        }
        ...
        public PerformanceDataValue[] GetPerfomanceValue(int ItemID, PerformanceType perf, System.DateTime startPeriod, System.DateTime endPeriod)
        {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGetPerfomanceValue(int ItemID, PerformanceType perf, System.DateTime startPeriod, System.DateTime endPeriod, System.AsyncCallback callback, object asyncState)
        {
        ...
        /// <remarks/>
        public void GetPerfomanceValueAsync(int ItemID, PerformanceType perf, System.DateTime startPeriod, System.DateTime endPeriod)
        {
            this.GetPerfomanceValueAsync(ItemID, perf, startPeriod, endPeriod, null);
        }

        /// <remarks/>
        public void GetPerfomanceValueAsync(int ItemID, PerformanceType perf, System.DateTime startPeriod, System.DateTime endPeriod, object userState)
        {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGetVirtualNetwork(int packageId, System.AsyncCallback callback, object asyncState)
        {
            return this.BeginInvoke("GetVirtualNetwork", new object[] {
                        packageId}, callback, asyncState);
        }

        /// <remarks/>
        public VirtualNetworkInfo[] EndGetVirtualNetwork(System.IAsyncResult asyncResult)
        {
            object[] results = this.EndInvoke(asyncResult);
            return ((VirtualNetworkInfo[])(results[0]));
        }
        ...
        /// <remarks/>
        public void GetVirtualNetworkAsync(int packageId)
        {
            this.GetVirtualNetworkAsync(packageId, null);
        }

        /// <remarks/>
        public void GetVirtualNetworkAsync(int packageId, object userState)
        {
            if ((this.GetVirtualNetworkOperationCompleted == null))
            {
                this.GetVirtualNetworkOperationCompleted = new System.Threading.SendOrPostCallback(this.OnGetVirtualNetworkOperationCompleted);
            }
            this.InvokeAsync("GetVirtualNetwork", new object[] {
                        packageId}, this.GetVirtualNetworkOperationCompleted, userState);
        }

        private void OnGetVirtualNetworkOperationCompleted(object arg)
        {
            if ((this.GetVirtualNetworkCompleted != null))
            {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.GetVirtualNetworkCompleted(this, new GetVirtualNetworkCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.42")]
    public delegate void GetVirtualNetworkCompletedEventHandler(object sender, GetVirtualNetworkCompletedEventArgs e);

    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("wsdl", "2.0.50727.42")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class GetVirtualNetworkCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs
    {

        private object[] results;

        internal GetVirtualNetworkCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) :
                base(exception, cancelled, userState)
        {
            this.results = results;
        }
