...
namespace SolidCP.EnterpriseServer.Services
{
    ...
    public interface IesVirtualizationServer2012
    {
        ...
        [WebMethod]
        [OperationContract]
        IntResult CreateNewVirtualMachine(VirtualMachine VMSettings, string osTemplateFile, string password, string summaryLetterEmail, int externalAddressesNumber, bool randomExternalAddresses, int[] externalAddresses, int privateAddressesNumber, bool randomPrivateAddresses, string[] privateAddresses);
        [WebMethod]
        [OperationContract]
        ...
        [WebMethod]
        [OperationContract]
        VirtualMachineNetworkAdapter[] GetVirtualMachinesNetwordAdapterSettings(int itemId);
        [WebMethod]
        [OperationContract]
        ResultObject ChangeAdministratorPassword(int itemId, string password);
        [WebMethod]
        [OperationContract]
        ResultObject ChangeAdministratorPasswordAndCleanResult(int itemId, string password);
        [WebMethod]
        [OperationContract]
        ResultObject UpdateVirtualMachineResource(int itemId, VirtualMachine vmSettings);
        [WebMethod]
        [OperationContract]
        ...
        [WebMethod]
        [OperationContract]
        ResultObject AddVirtualMachineExternalIPAddressesByInjection(int itemId, bool selectRandom, int addressesNumber, int[] addressId);
        [WebMethod]
        [OperationContract]
        ResultObject DeleteVirtualMachineExternalIPAddressesByInjection(int itemId, int[] addressId);
        [WebMethod]
        [OperationContract]
        ResultObject RestoreVirtualMachineExternalIPAddressesByInjection(int itemId);
        [WebMethod]
        [OperationContract]
        ...
        [WebMethod]
        [OperationContract]
        ResultObject RestoreVirtualMachinePrivateIPAddressesByInjection(int itemId);
        [WebMethod]
        [OperationContract]
        ResultObject AddVirtualMachinePrivateIPAddressesByInject(int itemId, bool selectRandom, int addressesNumber, string[] addresses, bool customGatewayAndDns, string gateway, string dns1, string dns2, string subnetMask);
        [WebMethod]
        [OperationContract]
        ResultObject AddVirtualMachinePrivateIPAddresses(int itemId, bool selectRandom, int addressesNumber, string[] addresses, bool customGatewayAndDns, string gateway, string dns1, string dns2, string subnetMask);
        [WebMethod]
        [OperationContract]
        ResultObject SetVirtualMachinePrimaryPrivateIPAddress(int itemId, int addressId);
        [WebMethod]
        [OperationContract]
        ResultObject DeleteVirtualMachinePrivateIPAddressesByInject(int itemId, int[] addressId);
        [WebMethod]
        [OperationContract]
        ...
        [WebMethod]
        [OperationContract]
        SecureBootTemplate[] GetSecureBootTemplates(int serviceId, string computerName);
        [WebMethod]
        [OperationContract]
        VMConfigurationVersion[] GetVMConfigurationVersionSupportedList(int serviceId);
        [WebMethod]
        [OperationContract]
        VirtualSwitch[] GetExternalSwitches(int serviceId, string computerName);
        [WebMethod]
        [OperationContract]
        VirtualSwitch[] GetExternalSwitchesWMI(int serviceId, string computerName);
        [WebMethod]
        [OperationContract]
        VirtualSwitch[] GetInternalSwitches(int serviceId, string computerName);
        [WebMethod]
        [OperationContract]
        ResultObject DeleteVirtualMachine(int itemId, bool saveFiles, bool exportVps, string exportPath);
        [WebMethod]
        [OperationContract]
        ResultObject DeleteVirtualMachineAsynchronous(int itemId, bool saveFiles, bool exportVps, string exportPath);
        [WebMethod]
        [OperationContract]
        IntResult ReinstallVirtualMachine(int itemId, VirtualMachine VMSettings, string adminPassword, string[] privIps, bool saveVirtualDisk, bool exportVps, string exportPath);
        [WebMethod]
        [OperationContract]
...
#endif
    public class esVirtualizationServer2012 : SolidCP.EnterpriseServer.esVirtualizationServer2012, IesVirtualizationServer2012
    {
    }
}
#endif