#pragma checksum "C:\GitHub\SolidCP\SolidCP\Sources\SolidCP.Build\ClientInterface.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8fb0778650bb4f46ec63ee4390321d90b1fad4c4"
// <auto-generated/>
...
#nullable disable
    ...
    #nullable disable
    {
        ...
        protected async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            WriteLiteral("\r\n");
#nullable restore
#line (14,3)-(14,39) 6 "C:\GitHub\SolidCP\SolidCP\Sources\SolidCP.Build\ClientInterface.cshtml"
...
#nullable disable
            WriteLiteral("\r\n");
#nullable restore
#line (15,3)-(15,56) 6 "C:\GitHub\SolidCP\SolidCP\Sources\SolidCP.Build\ClientInterface.cshtml"
...
#nullable restore
#line (17,40)-(17,56) 6 "C:\GitHub\SolidCP\SolidCP\Sources\SolidCP.Build\ClientInterface.cshtml"
...
#nullable restore
#line (17,73)-(17,92) 6 "C:\GitHub\SolidCP\SolidCP\Sources\SolidCP.Build\ClientInterface.cshtml"
...
#nullable disable
            WriteLiteral("\")]\r\npublic interface I");
#nullable restore
#line (18,21)-(18,37) 6 "C:\GitHub\SolidCP\SolidCP\Sources\SolidCP.Build\ClientInterface.cshtml"
Write(Class.Identifier);
...
#nullable disable
            WriteLiteral(" {\r\n\r\n");
#nullable restore
#line 20 "C:\GitHub\SolidCP\SolidCP\Sources\SolidCP.Build\ClientInterface.cshtml"
...
#nullable disable
#nullable restore
#line (24,5)-(24,140) 6 "C:\GitHub\SolidCP\SolidCP\Sources\SolidCP.Build\ClientInterface.cshtml"
Write(method.Item2 != null ? method.Item2.NormalizeWhitespace() : "\n\n// No async method, because method has ref, in or out parameters.\n\n");

#line default
#line hidden
#nullable disable
#nullable restore
#line 24 "C:\GitHub\SolidCP\SolidCP\Sources\SolidCP.Build\ClientInterface.cshtml"
...
#nullable restore
#line 30 "C:\GitHub\SolidCP\SolidCP\Sources\SolidCP.Build\ClientInterface.cshtml"
	...
	public IEnumerable<Tuple<MethodDeclarationSyntax, MethodDeclarationSyntax>> Methods => WebMethods
			...
			.Select(m => new Tuple<MethodDeclarationSyntax, MethodDeclarationSyntax>(
				...
				m.IsRefPar ? null : MethodDeclaration(ParseTypeName((m.IsVoid) ? "System.Threading.Tasks.Task" : $"System.Threading.Tasks.Task<{m.Method.ReturnType}>"), $"{m.Method.Identifier}Async")
					.WithAttributeLists(SingletonList(AttributeList(SingletonSeparatedList(Attribute(IdentifierName("OperationContract"),
						ParseAttributeArgumentList($"(Action = \"{WebServiceNamespace}I{Class.Identifier}/{m.Method.Identifier}\", ReplyAction = \"{WebServiceNamespace}I{Class.Identifier}/{m.Method.Identifier}Response\")"))))))
					.WithParameterList(m.Method.ParameterList)
					.WithSemicolonToken(Token(SyntaxKind.SemicolonToken))
