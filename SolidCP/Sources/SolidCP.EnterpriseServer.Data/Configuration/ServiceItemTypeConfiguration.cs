...
public partial class ServiceItemTypeConfiguration: EntityTypeConfiguration<ServiceItemType>
{
    public override void Configure() {
        ...
        HasData(() => new ServiceItemType[] {
			...
			new ServiceItemType() { ItemTypeId = 90, Backupable = true, CalculateBandwidth = false, CalculateDiskspace = true, DisplayName = "MySQL9Database", Disposable = true,
				GroupId = 91, Importable = true, Searchable = true, Suspendable = false, TypeName = "SolidCP.Providers.Database.SqlDatabase, SolidCP.Providers.Base", TypeOrder = 20 },
			new ServiceItemType() { ItemTypeId = 91, Backupable = true, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "MySQL9User", Disposable = true,
				GroupId = 91, Importable = true, Searchable = true, Suspendable = false, TypeName = "SolidCP.Providers.Database.SqlUser, SolidCP.Providers.Base", TypeOrder = 21 },
