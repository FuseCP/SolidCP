...
public partial class ResourceGroupConfiguration : Extensions.EntityTypeConfiguration<ResourceGroup>
{
	...
	public override void Configure()
	{
		...
		HasData(
			...
			new ResourceGroup() { GroupId = 12, GroupController = null, GroupName = "Exchange", GroupOrder = 5, ShowGroup = true },
			new ResourceGroup() { GroupId = 13, GroupController = null, GroupName = "Hosted Organizations", GroupOrder = 6, ShowGroup = true },
			...
			new ResourceGroup() { GroupId = 21, GroupController = null, GroupName = "Hosted CRM", GroupOrder = 16, ShowGroup = true },
			...
			new ResourceGroup() { GroupId = 24, GroupController = null, GroupName = "Hosted CRM2013", GroupOrder = 16, ShowGroup = true },
			new ResourceGroup() { GroupId = 30, GroupController = null, GroupName = "VPS", GroupOrder = 19, ShowGroup = true },
			new ResourceGroup() { GroupId = 31, GroupController = null, GroupName = "BlackBerry", GroupOrder = 21, ShowGroup = true },
			new ResourceGroup() { GroupId = 32, GroupController = null, GroupName = "OCS", GroupOrder = 22, ShowGroup = true },
			new ResourceGroup() { GroupId = 33, GroupController = null, GroupName = "VPS2012", GroupOrder = 20, ShowGroup = true },
			new ResourceGroup() { GroupId = 40, GroupController = null, GroupName = "VPSForPC", GroupOrder = 20, ShowGroup = true },
			new ResourceGroup() { GroupId = 41, GroupController = null, GroupName = "Lync", GroupOrder = 24, ShowGroup = true },
			...
			new ResourceGroup() { GroupId = 45, GroupController = null, GroupName = "RDS", GroupOrder = 27, ShowGroup = true },
			...
			new ResourceGroup() { GroupId = 47, GroupController = null, GroupName = "Service Levels", GroupOrder = 2, ShowGroup = true },
			...
			new ResourceGroup() { GroupId = 52, GroupController = null, GroupName = "SfB", GroupOrder = 26, ShowGroup = true },
			new ResourceGroup() { GroupId = 61, GroupController = null, GroupName = "MailFilters", GroupOrder = 5, ShowGroup = true },
			...
			new ResourceGroup() { GroupId = 167, GroupController = null, GroupName = "Proxmox", GroupOrder = 20, ShowGroup = true }
		);
		#endregion
	}
#endif
