...
#region Seed Data
        HasData(
            new ServiceItemType() { ItemTypeId = 2, Backupable = true, CalculateBandwidth = false, CalculateDiskspace = true, DisplayName = "HomeFolder", Disposable = true,
                GroupId = 1, Importable = false, Searchable = false, Suspendable = false, TypeName = "SolidCP.Providers.OS.HomeFolder, SolidCP.Providers.Base", TypeOrder = 15 },
            ...
            new ServiceItemType() { ItemTypeId = 12, Backupable = true, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "DNSZone", Disposable = true,
                GroupId = 7, Importable = true, Searchable = false, Suspendable = true, TypeName = "SolidCP.Providers.DNS.DnsZone, SolidCP.Providers.Base", TypeOrder = 0 },
            new ServiceItemType() { ItemTypeId = 13, Backupable = false, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "Domain", Disposable = false,
                GroupId = 1, Importable = false, Searchable = true, Suspendable = false, TypeName = "SolidCP.Providers.OS.Domain, SolidCP.Providers.Base", TypeOrder = 1 },
            ...
            new ServiceItemType() { ItemTypeId = 15, Backupable = false, CalculateBandwidth = false, CalculateDiskspace = true, DisplayName = "MailAccount", Disposable = false,
                GroupId = 4, Importable = false, Searchable = true, Suspendable = false, TypeName = "SolidCP.Providers.Mail.MailAccount, SolidCP.Providers.Base", TypeOrder = 4 },
            new ServiceItemType() { ItemTypeId = 16, Backupable = false, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "MailAlias", Disposable = false,
                GroupId = 4, Importable = false, Searchable = true, Suspendable = false, TypeName = "SolidCP.Providers.Mail.MailAlias, SolidCP.Providers.Base", TypeOrder = 5 },
            new ServiceItemType() { ItemTypeId = 17, Backupable = false, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "MailList", Disposable = false,
                GroupId = 4, Importable = false, Searchable = true, Suspendable = false, TypeName = "SolidCP.Providers.Mail.MailList, SolidCP.Providers.Base", TypeOrder = 7 },
            new ServiceItemType() { ItemTypeId = 18, Backupable = false, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "MailGroup", Disposable = false,
                GroupId = 4, Importable = false, Searchable = true, Suspendable = false, TypeName = "SolidCP.Providers.Mail.MailGroup, SolidCP.Providers.Base", TypeOrder = 6 },
            ...
            new ServiceItemType() { ItemTypeId = 25, Backupable = true, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "SharedSSLFolder", Disposable = true,
                GroupId = 2, Importable = false, Searchable = true, Suspendable = false, TypeName = "SolidCP.Providers.Web.SharedSSLFolder, SolidCP.Providers.Base", TypeOrder = 21 },
            new ServiceItemType() { ItemTypeId = 28, Backupable = true, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "SecondaryDNSZone", Disposable = true,
                GroupId = 7, Importable = false, Searchable = false, Suspendable = true, TypeName = "SolidCP.Providers.DNS.SecondaryDnsZone, SolidCP.Providers.Base", TypeOrder = 0 },
            new ServiceItemType() { ItemTypeId = 29, Backupable = true, CalculateBandwidth = false, CalculateDiskspace = true, DisplayName = "Organization", Disposable = true,
                GroupId = 13, Importable = false, Searchable = true, Suspendable = true, TypeName = "SolidCP.Providers.HostedSolution.Organization, SolidCP.Providers.Base", TypeOrder = 1 },
            new ServiceItemType() { ItemTypeId = 30, Backupable = true, CalculateBandwidth = null, CalculateDiskspace = null, DisplayName = "OrganizationDomain", Disposable = null,
                GroupId = 13, Importable = false, Searchable = null, Suspendable = null, TypeName = "SolidCP.Providers.HostedSolution.OrganizationDomain, SolidCP.Providers.Base", TypeOrder = 1 },
            ...
            new ServiceItemType() { ItemTypeId = 33, Backupable = false, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "VirtualMachine", Disposable = true,
                GroupId = 30, Importable = false, Searchable = true, Suspendable = true, TypeName = "SolidCP.Providers.Virtualization.VirtualMachine, SolidCP.Providers.Base", TypeOrder = 1 },
            new ServiceItemType() { ItemTypeId = 34, Backupable = false, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "VirtualSwitch", Disposable = true,
                GroupId = 30, Importable = false, Searchable = true, Suspendable = true, TypeName = "SolidCP.Providers.Virtualization.VirtualSwitch, SolidCP.Providers.Base", TypeOrder = 2 },
            new ServiceItemType() { ItemTypeId = 35, Backupable = false, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "VMInfo", Disposable = true,
                GroupId = 40, Importable = false, Searchable = true, Suspendable = true, TypeName = "SolidCP.Providers.Virtualization.VMInfo, SolidCP.Providers.Base", TypeOrder = 1 },
            new ServiceItemType() { ItemTypeId = 36, Backupable = false, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "VirtualSwitch", Disposable = true,
                GroupId = 40, Importable = false, Searchable = true, Suspendable = true, TypeName = "SolidCP.Providers.Virtualization.VirtualSwitch, SolidCP.Providers.Base", TypeOrder = 2 },
            ...
            new ServiceItemType() { ItemTypeId = 41, Backupable = false, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "VirtualMachine", Disposable = true,
                GroupId = 33, Importable = false, Searchable = true, Suspendable = true, TypeName = "SolidCP.Providers.Virtualization.VirtualMachine, SolidCP.Providers.Base", TypeOrder = 1 },
            new ServiceItemType() { ItemTypeId = 42, Backupable = false, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "VirtualSwitch", Disposable = true,
                GroupId = 33, Importable = false, Searchable = true, Suspendable = true, TypeName = "SolidCP.Providers.Virtualization.VirtualSwitch, SolidCP.Providers.Base", TypeOrder = 2 },
            ...
            new ServiceItemType() { ItemTypeId = 143, Backupable = false, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "VirtualMachine", Disposable = true,
                GroupId = 167, Importable = false, Searchable = true, Suspendable = true, TypeName = "SolidCP.Providers.Virtualization.VirtualMachine, SolidCP.Providers.Base", TypeOrder = 1 },
            new ServiceItemType() { ItemTypeId = 144, Backupable = false, CalculateBandwidth = false, CalculateDiskspace = false, DisplayName = "VirtualSwitch", Disposable = true,
                GroupId = 167, Importable = false, Searchable = true, Suspendable = true, TypeName = "SolidCP.Providers.Virtualization.VirtualSwitch, SolidCP.Providers.Base", TypeOrder = 2 },
