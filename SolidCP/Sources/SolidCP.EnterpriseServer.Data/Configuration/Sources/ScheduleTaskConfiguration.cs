...
#region Seed Data
        HasData(
            new ScheduleTask() { TaskId = "SCHEDULE_TASK_ACTIVATE_PAID_INVOICES", RoleId = 0, TaskType = "SolidCP.Ecommerce.EnterpriseServer.ActivatePaidInvoicesTask, SolidCP.EnterpriseS" +
                "erver.Code" },
            ...
            new ScheduleTask() { TaskId = "SCHEDULE_TASK_CALCULATE_PACKAGES_DISKSPACE", RoleId = 1, TaskType = "SolidCP.EnterpriseServer.CalculatePackagesDiskspaceTask, SolidCP.EnterpriseServe" +
                "r.Code" },
            new ScheduleTask() { TaskId = "SCHEDULE_TASK_CANCEL_OVERDUE_INVOICES", RoleId = 0, TaskType = "SolidCP.Ecommerce.EnterpriseServer.CancelOverdueInvoicesTask, SolidCP.Enterprise" +
                "Server.Code" },
            ...
            new ScheduleTask() { TaskId = "SCHEDULE_TASK_GENERATE_INVOICES", RoleId = 0, TaskType = "SolidCP.Ecommerce.EnterpriseServer.GenerateInvoicesTask, SolidCP.EnterpriseServe" +
                "r.Code" },
            ...
            new ScheduleTask() { TaskId = "SCHEDULE_TASK_NOTIFY_OVERUSED_DATABASES", RoleId = 2, TaskType = "SolidCP.EnterpriseServer.NotifyOverusedDatabasesTask, SolidCP.EnterpriseServer.C" +
                "ode" },
            new ScheduleTask() { TaskId = "SCHEDULE_TASK_RUN_PAYMENT_QUEUE", RoleId = 0, TaskType = "SolidCP.Ecommerce.EnterpriseServer.RunPaymentQueueTask, SolidCP.EnterpriseServer" +
                ".Code" },
            ...
            new ScheduleTask() { TaskId = "SCHEDULE_TASK_SUSPEND_OVERDUE_INVOICES", RoleId = 0, TaskType = "SolidCP.Ecommerce.EnterpriseServer.SuspendOverdueInvoicesTask, SolidCP.Enterpris" +
                "eServer.Code" },
