...
#region Seed Data
        HasData(
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_AUDIT_LOG_REPORT", ParameterId = "MAIL_TO", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CHECK_WEBSITE", ParameterId = "PASSWORD", DataTypeId = "String", DefaultValue = null, ParameterOrder = 3 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CHECK_WEBSITE", ParameterId = "RESPONSE_CONTAIN", DataTypeId = "String", DefaultValue = null, ParameterOrder = 5 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CHECK_WEBSITE", ParameterId = "RESPONSE_DOESNT_CONTAIN", DataTypeId = "String", DefaultValue = null, ParameterOrder = 6 },
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_CHECK_WEBSITE", ParameterId = "USERNAME", DataTypeId = "String", DefaultValue = null, ParameterOrder = 2 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_DOMAIN_EXPIRATION", ParameterId = "DAYS_BEFORE", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_DOMAIN_EXPIRATION", ParameterId = "MAIL_TO", DataTypeId = "String", DefaultValue = null, ParameterOrder = 2 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_DOMAIN_LOOKUP", ParameterId = "DNS_SERVERS", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_DOMAIN_LOOKUP", ParameterId = "MAIL_TO", DataTypeId = "String", DefaultValue = null, ParameterOrder = 2 },
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_FTP_FILES", ParameterId = "FTP_FOLDER", DataTypeId = "String", DefaultValue = null, ParameterOrder = 5 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_FTP_FILES", ParameterId = "FTP_PASSWORD", DataTypeId = "String", DefaultValue = null, ParameterOrder = 4 },
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_FTP_FILES", ParameterId = "FTP_USERNAME", DataTypeId = "String", DefaultValue = null, ParameterOrder = 3 },
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_HOSTED_SOLUTION_REPORT", ParameterId = "EMAIL", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_RUN_SYSTEM_COMMAND", ParameterId = "SERVER_NAME", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_SEND_MAIL", ParameterId = "MAIL_BODY", DataTypeId = "MultiString", DefaultValue = null, ParameterOrder = 4 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_SEND_MAIL", ParameterId = "MAIL_FROM", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_SEND_MAIL", ParameterId = "MAIL_SUBJECT", DataTypeId = "String", DefaultValue = null, ParameterOrder = 3 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_SEND_MAIL", ParameterId = "MAIL_TO", DataTypeId = "String", DefaultValue = null, ParameterOrder = 2 },
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_SUSPEND_PACKAGES", ParameterId = "SUSPENSION_MAIL_BCC", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_SUSPEND_PACKAGES", ParameterId = "SUSPENSION_MAIL_BODY", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_SUSPEND_PACKAGES", ParameterId = "SUSPENSION_MAIL_FROM", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_SUSPEND_PACKAGES", ParameterId = "SUSPENSION_MAIL_SUBJECT", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_SUSPEND_PACKAGES", ParameterId = "WARNING_MAIL_BCC", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_SUSPEND_PACKAGES", ParameterId = "WARNING_MAIL_BODY", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_SUSPEND_PACKAGES", ParameterId = "WARNING_MAIL_FROM", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_SUSPEND_PACKAGES", ParameterId = "WARNING_MAIL_SUBJECT", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            ...
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_USER_PASSWORD_EXPIRATION_NOTIFICATION", ParameterId = "DAYS_BEFORE_EXPIRATION", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
            new ScheduleTaskParameter() { TaskId = "SCHEDULE_TASK_ZIP_FILES", ParameterId = "FOLDER", DataTypeId = "String", DefaultValue = null, ParameterOrder = 1 },
