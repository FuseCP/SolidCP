    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RecordID = table.Column<string>(type: "TEXT", unicode: false, maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisclaimerName = table.Column<string>(type: "TEXT", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TagID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ItemID = table.Column<int>(type: "INTEGER", nullable: false),
                    TagName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OCSUserID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AccountID = table.Column<int>(type: "INTEGER", nullable: false),
                    InstanceID = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PackageID = table.Column<int>(type: "INTEGER", nullable: false),
                    SettingsName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemoteUserAccess = table.Column<bool>(type: "INTEGER", nullable: false),
                    PublicIMConnectivity = table.Column<bool>(type: "INTEGER", nullable: false),
                    AllowOrganizeMeetingsWithExternalAnonymous = table.Column<bool>(type: "INTEGER", nullable: false),
                    Telephony = table.Column<int>(type: "INTEGER", nullable: true),
                    ServerURI = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    ArchivePolicy = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    TelephonyDialPlanPolicy = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    TelephonyVoicePolicy = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ThemeID = table.Column<int>(type: "INTEGER", nullable: false),
                    SettingsName = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPeer = table.Column<bool>(type: "INTEGER", nullable: false),
                    Username = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    ...
                    MfaMode = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Email = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    CompanyName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    FullName = table.Column<string>(type: "TEXT", maxLength: 101, nullable: true),
                    OwnerUsername = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    OwnerFirstName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    OwnerLastName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    OwnerRoleID = table.Column<int>(type: "INTEGER", nullable: true),
                    OwnerFullName = table.Column<string>(type: "TEXT", maxLength: 101, nullable: true),
                    OwnerEmail = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    PackagesNumber = table.Column<int>(type: "INTEGER", nullable: true),
                    EcommerceEnabled = table.Column<bool>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersDetailed", x => x.UserID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupID = table.Column<int>(type: "INTEGER", nullable: false),
                    RecordType = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comments = table.Column<string>(type: "ntext", nullable: true),
                    VirtualServer = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    ADAuthenticationType = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: true),
                    ...
                    OSPlatform = table.Column<int>(type: "INTEGER", nullable: false),
                    IsCore = table.Column<bool>(type: "INTEGER", nullable: true),
                    PasswordIsSHA256 = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    TaskID = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    ParameterID = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    TaskID = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    ConfigurationID = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommentID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ItemTypeID = table.Column<string>(type: "TEXT", unicode: false, maxLength: 50, nullable: false),
                    ItemID = table.Column<int>(type: "INTEGER", nullable: false),
                    UserID = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AddressID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ExternalIP = table.Column<string>(type: "TEXT", unicode: false, maxLength: 24, nullable: false),
                    InternalIP = table.Column<string>(type: "TEXT", unicode: false, maxLength: 24, nullable: true),
                    ServerID = table.Column<int>(type: "INTEGER", nullable: true),
                    Comments = table.Column<string>(type: "ntext", nullable: true),
                    SubnetMask = table.Column<string>(type: "TEXT", unicode: false, maxLength: 15, nullable: true),
                    DefaultGateway = table.Column<string>(type: "TEXT", unicode: false, maxLength: 15, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuotaName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DomainName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    HostingAllowed = table.Column<bool>(type: "INTEGER", nullable: false),
                    WebSiteID = table.Column<int>(type: "INTEGER", nullable: true),
                    MailDomainID = table.Column<int>(type: "INTEGER", nullable: true),
                    IsSubDomain = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsPreviewDomain = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MailboxPlanId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ItemID = table.Column<int>(type: "INTEGER", nullable: false),
                    MailboxPlan = table.Column<string>(type: "TEXT", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ItemId = table.Column<int>(type: "INTEGER", nullable: false),
                    SettingsName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LyncUserPlanId = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ItemID = table.Column<int>(type: "INTEGER", nullable: false),
                    LyncUserPlanName = table.Column<string>(type: "TEXT", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RecordID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    RecordType = table.Column<string>(type: "TEXT", unicode: false, maxLength: 10, nullable: false),
                    RecordName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OverrideQuotas = table.Column<bool>(type: "INTEGER", nullable: false),
                    BandwidthUpdated = table.Column<DateTime>(type: "datetime", nullable: true),
                    DefaultTopPackage = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScheduleTypeID = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
