...
{
    public class SqliteDbContext_1_4_9: SqliteDbContext {
#if NetCore
        public SqliteDbContext_1_4_9(string connectionString, bool initSeedData = false): base(connectionString, initSeedData) { }
	    public SqliteDbContext_1_4_9(DbContext context): base(context) { }
	    public SqliteDbContext_1_4_9(DbContextOptions<Context.DbContextBase> options): base(options) { }
#else
	    public SqliteDbContext_1_4_9(DbContext context): base(context) { }        
#endif
	}
    
    [DbContext(typeof(SqliteDbContext_1_4_9))]
    partial class SqliteDbContextModelSnapshot_1_4_9 : ModelSnapshot
