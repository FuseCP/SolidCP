...
{
    public class PostgreSqlDbContext_1_4_9: PostgreSqlDbContext {
#if NetCore
        public PostgreSqlDbContext_1_4_9(string connectionString, bool initSeedData = false): base(connectionString, initSeedData) { }
	    public PostgreSqlDbContext_1_4_9(DbContext context): base(context) { }
	    public PostgreSqlDbContext_1_4_9(DbContextOptions<Context.DbContextBase> options): base(options) { }
#else
	    public PostgreSqlDbContext_1_4_9(DbContext context): base(context) { }        
#endif
	}
    
    [DbContext(typeof(PostgreSqlDbContext_1_4_9))]
    partial class PostgreSqlDbContextModelSnapshot_1_4_9 : ModelSnapshot
