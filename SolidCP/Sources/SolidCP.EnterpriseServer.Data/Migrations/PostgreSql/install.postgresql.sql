...
BEGIN
    ...
    CREATE TABLE public."BackgroundTaskLogs" (
        ...
        CONSTRAINT "FK__Backgroun__TaskI__06ADD4BD" FOREIGN KEY ("TaskID") REFERENCES public."BackgroundTasks" ("ID")
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE public."BackgroundTaskParameters" (
        ...
        CONSTRAINT "FK__Backgroun__TaskI__03D16812" FOREIGN KEY ("TaskID") REFERENCES public."BackgroundTasks" ("ID")
    );
    END IF;
END $EF$;
...
BEGIN
    ...
    CREATE TABLE public."BackgroundTaskStack" (
        ...
        CONSTRAINT "FK__Backgroun__TaskI__098A4168" FOREIGN KEY ("TaskID") REFERENCES public."BackgroundTasks" ("ID")
    );
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240708170548_InitialCreate') THEN
    INSERT INTO public."ThemeSettings" ("PropertyName", "SettingsName", "ThemeID", "PropertyValue")
...
BEGIN
    ...
    INSERT INTO public."Quotas" ("QuotaID", "GroupID", "HideQuota", "ItemTypeID", "PerOrganization", "QuotaDescription", "QuotaName", "QuotaOrder", "QuotaTypeID", "ServiceQuota")
    VALUES (701, 71, NULL, 39, NULL, 'Databases', 'MsSQL2016.Databases', 1, 2, FALSE);
    INSERT INTO public."Quotas" ("QuotaID", "GroupID", "HideQuota", "ItemTypeID", "PerOrganization", "QuotaDescription", "QuotaName", "QuotaOrder", "QuotaTypeID", "ServiceQuota")
    VALUES (702, 71, NULL, 40, NULL, 'Users', 'MsSQL2016.Users', 2, 2, FALSE);
    INSERT INTO public."Quotas" ("QuotaID", "GroupID", "HideQuota", "ItemTypeID", "PerOrganization", "QuotaDescription", "QuotaName", "QuotaOrder", "QuotaTypeID", "ServiceQuota")
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20240708170548_InitialCreate') THEN
    CREATE INDEX "PackagesTreeCacheIndex" ON public."PackagesTreeCache" ("ParentPackageID", "PackageID");
    END IF;
END $EF$;
