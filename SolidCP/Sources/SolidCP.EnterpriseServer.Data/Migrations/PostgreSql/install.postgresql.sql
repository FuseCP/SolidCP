...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241012194454_InitialCreate') THEN
...
BEGIN
    ...
    CREATE TABLE public."SfBUserPlans" (
        ...
        "RemoteUserAccess" boolean NOT NULL,
        "PublicIMConnectivity" boolean NOT NULL,
        "AllowOrganizeMeetingsWithExternalAnonymous" boolean NOT NULL,
        "Telephony" integer,
...
BEGIN
    ...
    CREATE TABLE public."Servers" (
        ...
        "Comments" TEXT,
        "VirtualServer" boolean NOT NULL,
        ...
        "IsCore" boolean,
        "PasswordIsSHA256" boolean NOT NULL,
...
BEGIN
    ...
    CREATE TABLE public."Packages" (
        ...
        "OverrideQuotas" boolean NOT NULL,
        "BandwidthUpdated" timestamp with time zone,
        "DefaultTopPackage" boolean NOT NULL,
...
BEGIN
    ...
    CREATE TABLE public."Domains" (
        ...
        "HostingAllowed" boolean NOT NULL,
        "WebSiteID" integer,
        "MailDomainID" integer,
        "IsSubDomain" boolean NOT NULL,
        "IsPreviewDomain" boolean NOT NULL,
...
BEGIN
    ...
    VALUES (1, NULL, '', TIMESTAMPTZ '2010-07-16T10:53:02.453Z', '', '', NULL, '', TIMESTAMPTZ '2010-07-16T12:53:02.453Z', TRUE, 'serveradmin@myhosting.com', NULL, '', 'Enterprise', TRUE, '', FALSE, FALSE, 'Administrator', NULL, 0, NULL, NULL, '', NULL, '', 1, '', '', '', 1, NULL, 'serveradmin', '');
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20241012194454_InitialCreate') THEN
    INSERT INTO public."Packages" ("PackageID", "BandwidthUpdated", "DefaultTopPackage", "OverrideQuotas", "PackageComments", "PackageName", "ParentPackageID", "PlanID", "PurchaseDate", "ServerID", "StatusID", "StatusIDchangeDate", "UserID")
    VALUES (1, NULL, FALSE, FALSE, '', 'System', NULL, NULL, NULL, NULL, 1, TIMESTAMPTZ '2024-04-20T11:02:58.56Z', 1);
    END IF;
END $EF$;
...
BEGIN
    ...
    VALUES ('20241012194454_InitialCreate', '8.0.10');
    END IF;
END $EF$;
COMMIT;
