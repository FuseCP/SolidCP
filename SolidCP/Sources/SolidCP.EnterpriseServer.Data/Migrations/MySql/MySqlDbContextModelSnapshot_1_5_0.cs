...
{
    public class MySqlDbContext_1_5_0: MySqlDbContext {
#if NetCore
        public MySqlDbContext_1_5_0(string connectionString, bool initSeedData = false): base(connectionString, initSeedData) { }
	    public MySqlDbContext_1_5_0(DbContext context): base(context) { }
	    public MySqlDbContext_1_5_0(DbContextOptions<Context.DbContextBase> options): base(options) { }
#else
	    public MySqlDbContext_1_5_0(DbContext context): base(context) { }        
#endif
	}
    
    [DbContext(typeof(MySqlDbContext_1_5_0))]
    partial class MySqlDbContextModelSnapshot_1_5_0 : ModelSnapshot
