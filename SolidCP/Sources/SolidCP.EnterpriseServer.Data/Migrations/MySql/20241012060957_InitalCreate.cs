        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemoteUserAccess = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    PublicIMConnectivity = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    AllowOrganizeMeetingsWithExternalAnonymous = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsPeer = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    Username = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comments = table.Column<string>(type: "TEXT", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    VirtualServer = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ...
                    PasswordIsSHA256 = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OverrideQuotas = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    BandwidthUpdated = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    DefaultTopPackage = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VlanID = table.Column<int>(type: "int", nullable: false),
                    PackageID = table.Column<int>(type: "int", nullable: false),
                    IsDmz = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DomainName = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    HostingAllowed = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    WebSiteID = table.Column<int>(type: "int", nullable: true),
                    MailDomainID = table.Column<int>(type: "int", nullable: true),
                    IsSubDomain = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsPreviewDomain = table.Column<bool>(type: "tinyint(1)", nullable: false),
