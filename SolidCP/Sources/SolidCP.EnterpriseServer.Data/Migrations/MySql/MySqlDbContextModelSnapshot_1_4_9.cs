...
{
    public class MySqlDbContext_1_4_9: MySqlDbContext {
#if NetCore
        public MySqlDbContext_1_4_9(string connectionString, bool initSeedData = false): base(connectionString, initSeedData) { }
	    public MySqlDbContext_1_4_9(DbContext context): base(context) { }
	    public MySqlDbContext_1_4_9(DbContextOptions<Context.DbContextBase> options): base(options) { }
#else
	    public MySqlDbContext_1_4_9(DbContext context): base(context) { }        
#endif
	}
    
    [DbContext(typeof(MySqlDbContext_1_4_9))]
    partial class MySqlDbContextModelSnapshot_1_4_9 : ModelSnapshot
