<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HostedSoluitonReportSummaryLetter.ascx.cs" Inherits="SolidCP.Portal.HostedSoluitonReportSummaryLetter" %>
<table>
    <tr>
