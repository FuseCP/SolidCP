...
<scp:EnableAsyncTasksSupport id="asyncTasks" runat="server"/>
				...
				<div class="panel-body form-horizontal">
                    ...
                    <asp:Panel runat="server" ID="panelFullAccessPermission">
                        ...
                        <uc2:AccountsList id="fullAccessPermission" runat="server" MailboxesEnabled="true" EnableMailboxOnly = "true" DistributionListsEnabled="true" SecurityGroupsEnabled="true">
                        </uc2:AccountsList>                                            
                    </asp:Panel>
                    ...
                    <asp:Panel runat="server" ID="panelSendAsPermission">
                        ...
                        <uc2:AccountsList id="sendAsPermission" runat="server" MailboxesEnabled="true" EnableMailboxOnly = "true" DistributionListsEnabled="true" SecurityGroupsEnabled="true">
                        </uc2:AccountsList>                                           
                    </asp:Panel>
                    ...
                    <asp:Panel runat="server" ID="panelOnBehalfOf">
                        ...
                        <uc2:AccountsList id="onBehalfOfPermissions" runat="server" MailboxesEnabled="true" EnableMailboxOnly = "true" DistributionListsEnabled="true" SecurityGroupsEnabled="true">
                        </uc2:AccountsList>                                            
                    </asp:Panel>
                    ...
                    <asp:Panel runat="server" ID="panelCalendarPermissions">
                        ...
                        <uc2:AccountsListWithPermissions id="calendarPermissions" runat="server" MailboxesEnabled="true" EnableMailboxOnly = "true" SecurityGroupsEnabled="true">
                    ...
                    <asp:Panel runat="server" ID="panelContactsPermissions">
                        ...
                        <uc2:AccountsListWithPermissions id="contactsPermissions" runat="server" MailboxesEnabled="true" EnableMailboxOnly = "true" SecurityGroupsEnabled="true">
                        </uc2:AccountsListWithPermissions>                                            
                    </asp:Panel>
