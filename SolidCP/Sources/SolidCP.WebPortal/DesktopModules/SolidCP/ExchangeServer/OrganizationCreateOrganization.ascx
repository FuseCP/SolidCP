				...
				<div class="panel-body form-horizontal">
					...
					<table>
						...
						<tr>
							...
							<td>
                            <asp:DropDownList id="ddlDomains" runat="server" CssClass="form-control" DataTextField="DomainName" DataValueField="DomainID" style="vertical-align:middle;" OnSelectedIndexChanged="ddlDomains_Changed" AutoPostBack="true"></asp:DropDownList>
							</td>
						</tr>
					</table>
