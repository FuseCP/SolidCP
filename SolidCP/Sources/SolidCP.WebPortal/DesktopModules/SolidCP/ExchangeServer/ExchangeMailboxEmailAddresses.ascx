<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExchangeMailboxEmailAddresses.ascx.cs" Inherits="SolidCP.Portal.ExchangeServer.ExchangeMailboxEmailAddresses" %>
...
<script type="text/javascript">
				...
				<div class="panel-body form-horizontal">
                    ...
                    <scp:MailboxTabs id="tabs" runat="server" SelectedTab="mailbox_addresses" />
                    </div>
					...
					<fieldset>
					   ...
					   <div class="row" style="padding:20px;max-width:1200px">
                           ...
                           <div class="input-group col-sm-10">
                               <scp:EmailAddress id="email" runat="server" class="form-control" ValidationGroup="AddEmail"></scp:EmailAddress>
