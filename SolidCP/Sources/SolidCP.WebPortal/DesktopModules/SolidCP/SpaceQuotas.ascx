...
<%--    <tr ID="pnlDomainPointers" runat="server">
    ...
    <tr ID="pnlMsSQL2016Databases" runat="server">
        ...
        <td class="Normal"><scp:Quota ID="quotamssql2016databases" runat="server" QuotaName="MsSQL2016.Databases" DisplayGauge="True"/></td>
    </tr>
    <tr ID="pnlMsSQL2017Databases" runat="server">
    ...
    <tr ID="pnlMsSQL2022Databases" runat="server">
