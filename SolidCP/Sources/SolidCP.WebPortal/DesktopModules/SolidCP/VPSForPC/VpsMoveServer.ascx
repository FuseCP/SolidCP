	    ...
	    <div class="panel panel-default">
                ...
                <div class="panel-body form-horizontal">
                    ...
                    <p>
                        ...
                        <CPCC:StyleButton id="btnMove" CssClass="btn btn-success" runat="server" OnClick="btnMove_Click" ValidationGroup="MoveWizard"> <i class="fa fa-check">&nbsp;</i>&nbsp;<asp:Localize runat="server" meta:resourcekey="btnMove"/> </CPCC:StyleButton>
                    </p>
