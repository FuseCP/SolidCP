<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SfBPhoneNumbers.ascx.cs" Inherits="SolidCP.Portal.SfBPhoneNumbers" %>
...
<div class="panel-body form-horizontal">
    ...
    <table cellspacing="6">
        <tr>
            ...
            <td><scp:Quota ID="addressesQuota" runat="server" QuotaName="SfB.PhoneNumbers" /></td>
        </tr>
    </table>
