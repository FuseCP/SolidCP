...
<%@ Register Src="SmarterMail100x_EditDomain_Sharing.ascx" TagName="SmarterMail100x_EditDomain_Sharing"
    TagPrefix="uc3" %>
<%@ Register Src="SmarterMail100x_EditDomain_Throttling.ascx" TagName="SmarterMail100x_EditDomain_Throttling"
    TagPrefix="uc5" %>
...
<asp:Panel runat="server" ID="FeaturesPanel">
    <uc4:SmarterMail100x_EditDomain_Features id="featuresSection" runat="server"></uc4:SmarterMail100x_EditDomain_Features>
...
<asp:Panel runat="server" ID="SharingPanel">
    <uc3:SmarterMail100x_EditDomain_Sharing id="sharingSection" runat="server"></uc3:SmarterMail100x_EditDomain_Sharing>
</asp:Panel>
...
<asp:Panel runat="server" ID="ThrottlingPanel">
    <uc5:SmarterMail100x_EditDomain_Throttling id="throttlingSection" runat="server"></uc5:SmarterMail100x_EditDomain_Throttling>
</asp:Panel>
