<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail_EditDomain_Sharing.ascx.cs" Inherits="SolidCP.Portal.ProviderControls.SmaterMail_EditDomain_Sharing" %>
<table width="100%">
    <tr>
