<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SmarterMail50_EditDomain_Throttling.ascx.cs" Inherits="SolidCP.Portal.ProviderControls.SmarterMail50_EditDomain_Throttling" %>
<table>
    <tr>
