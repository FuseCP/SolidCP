<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AbilityMailServer_EditDomain.ascx.cs" Inherits="SolidCP.Portal.ProviderControls.AbilityMailServer_EditDomain" %>
<table width="100%">
    <tr>
