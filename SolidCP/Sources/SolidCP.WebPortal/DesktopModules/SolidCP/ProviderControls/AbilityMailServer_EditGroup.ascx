<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AbilityMailServer_EditGroup.ascx.cs" Inherits="SolidCP.Portal.ProviderControls.AbilityMailServer_EditGroup" %>
