<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SettingsUserPasswordRequestLetter.ascx.cs" Inherits="SolidCP.Portal.SettingsUserPasswordRequestLetter" %>
