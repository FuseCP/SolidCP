...
{
    public static class ProxmoxJobHelper
    {
        ...
        public static JobResult CreateResult(ConcreteJobState state = ConcreteJobState.Completed, ReturnCode returnCode = ReturnCode.OK)
        {
            return new JobResult
            {
                Job = new ConcreteJob { JobState = state },
                ReturnValue = returnCode
            };

        }

        public static JobResult CreateResultUpid(Upid jobstatus, ConcreteJobState state = ConcreteJobState.Running, ReturnCode returnCode = ReturnCode.JobStarted)
        {
            return new JobResult
            {
                Job = new ConcreteJob {
