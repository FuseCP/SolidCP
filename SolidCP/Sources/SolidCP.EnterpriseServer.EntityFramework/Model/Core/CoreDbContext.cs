...
namespace SolidCP.EnterpriseServer.Core
{
    ...
    public class CoreDbContext : DbContext, Data.IGenericDbContext, ICoreDbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Server=(local)\SQLExpress;Database=SolidCP;uid=sa;pwd=Password12");
            }
        }
        ...
        public int AddAccessToken(out int? tokenId, Guid? accessToken = null, DateTime? expirationDate = null, int? accountId = null, int? itemId = null, int? tokenType = null)
        {
            ...
            Database.ExecuteSqlRaw("EXEC @procResult = [dbo].[AddAccessToken] @TokenID OUTPUT, @AccessToken, @ExpirationDate, @AccountID, @ItemId, @TokenType", tokenIdParam, accessTokenParam, expirationDateParam, accountIdParam, itemIdParam, tokenTypeParam, procResultParam);
        ...
        public int AddAdditionalGroup(out int? groupId, int? userId, string groupName)
        {
            ...
            Database.ExecuteSqlRaw("EXEC @procResult = [dbo].[AddAdditionalGroup] @GroupID OUTPUT, @UserID, @GroupName", groupIdParam, userIdParam, groupNameParam, procResultParam);
        ...
        public int AddBackgroundTaskLog(int? taskId, DateTime? date, string exceptionStackTrace, int? innerTaskStart, int? severity, string text, int? textIdent, string xmlParameters)
        {
            ...
            Database.ExecuteSqlRaw("EXEC @procResult = [dbo].[AddBackgroundTaskLog] @TaskID, @Date, @ExceptionStackTrace, @InnerTaskStart, @Severity, @Text, @TextIdent, @XmlParameters", taskIdParam, dateParam, exceptionStackTraceParam, innerTaskStartParam, severityParam, textParam, textIdentParam, xmlParametersParam, procResultParam);
        ...
        public int AddBackgroundTaskParam(int? taskId, string name, string value, string typeName)
        {
            ...
            Database.ExecuteSqlRaw("EXEC @procResult = [dbo].[AddBackgroundTaskParam] @TaskID, @Name, @Value, @TypeName", taskIdParam, nameParam, valueParam, typeNameParam, procResultParam);
        ...
        public int AddBackgroundTaskStack(int? taskId = null)
        {
            ...
            Database.ExecuteSqlRaw("EXEC @procResult = [dbo].[AddBackgroundTaskStack] @TaskID", taskIdParam, procResultParam);
        ...
        public int AddBlackBerryUser(int? accountId = null)
        {
            ...
            Database.ExecuteSqlRaw("EXEC @procResult = [dbo].[AddBlackBerryUser] @AccountID", accountIdParam, procResultParam);
        ...
        public int AddCluster(out int? clusterId, string clusterName)
        {
            ...
            Database.ExecuteSqlRaw("EXEC @procResult = [dbo].[AddCluster] @ClusterID OUTPUT, @ClusterName", clusterIdParam, clusterNameParam, procResultParam);
        ...
        public int AddComment(int? actorId, string itemTypeId, int? itemId, string commentText, int? severityId = null)
        {
            ...
            Database.ExecuteSqlRaw("EXEC @procResult = [dbo].[AddComment] @ActorID, @ItemTypeID, @ItemID, @CommentText, @SeverityID", actorIdParam, itemTypeIdParam, itemIdParam, commentTextParam, severityIdParam, procResultParam);
