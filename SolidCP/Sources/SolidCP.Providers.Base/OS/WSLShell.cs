...
namespace SolidCP.Providers.OS
{
    ...
    public class WSLShell : Shell
    {
        ...
        {
            get => wslConfiguration ?? (wslConfiguration = new WSLConfiguration(this));
            private set => wslConfiguration = value;
        }
        public WSLGlobalConfiguration GlobalConfiguration => wslGlobalConfiguration ?? (wslGlobalConfiguration = new WSLGlobalConfiguration(this));
        public WSLGlobalConfiguration GlobalConfigurationFor(string user) => new WSLGlobalConfiguration(this, user);
